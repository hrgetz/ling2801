...
| | | 
| --- | --- |
| **Professor** | Heidi Getz, Ph.D. [heidi.getz@georgetown.edu](mailto:heidi.getz@georgetown.edu) <br> Poulton Hall 223 (Linguistics), Building D 145 (Neurology) <br> Office Hours: Thursdays 12-1:30, Poulton 223| 
| **Teaching Assistant** | Sunwoo (Sunny) Lee [sl2127@georgetown.edu](mailto:sl2127@georgetown.edu) <br> Office hours: Tuesdays 11am-12pm, Poulton Hall lounge |
| **Class schedule** | Tues/Thurs 9:30-10:45, White-Gravenor 202| 
| **Prerequisites** | None  | 
| **Required texts** | Brennan, J. R. (2022). *Language and the brain: a slim guide to neurolinguistics*. Oxford University Press. [Link to purchase text at bookstore](https://georgetown.bncollege.com/course-material-listing-page?utm_campaign=storeId=88131_langId=-1_courseData=LING_2801_01_F26&utm_source=wcs&utm_medium=registration_integration) <br>Additional readings are linked on the [schedule](schedule.md).
...
* The ability to construct clear, coherent, and evidence-based scientific explanations about language in the brain
...
The cute clipart that appears throughout this course website and in my slides was created by illustrator Laura Strickland of [MyCuteGraphics.com](https://www.mycutegraphics.com/). Images are not AI-generated.

### Teaching resources

I gratefully acknowledge our textbook, authored by [Jon Brennan](https://jobrenn.gitlab.io/), on which some of my lecture content is based. I also gratefully acknowledge my colleagues at other universities who developed syllabi that I looked to for inspiration, incuding [Katie Schuler](https://kschuler.github.io/ling104/), [Jon Brennan](https://jobrenn.gitlab.io/teaching/Syllabus_IntroNeuro_W25.html), [Ellen Lau](https://ellenlau.net/), and [Liina Pylkkanen](https://wp.nyu.edu/neurolinglab/neural-bases-of-language-fall-2026/)

Additional teaching resources that I drew on are linked on the relevant course unit pages (see [schedule](schedule.md)).
...
* Search for human-created teaching resources online, such as small group activities and brain atlases
* Identify teaching tools like Mentimeter
* Brainstorm ways to present course content
* Test out drafts of assignments and discussion questions
* Generate the first draft of this AI use statement

I did not use AI to develop any substantive aspects of the course, such as the course learning goals, reading list, lecture material, assignments, or exam questions.